...
('m1_l1', 1, 'O que a pesquisa de Neil Rackham encontrou ao observar 35 mil visitas de venda?',
 array['Que os melhores vendedores falavam menos e perguntavam mais',
       'Que os melhores vendedores conheciam melhor o produto',
       'Que os melhores vendedores insistiam mais no fechamento',
       'Que os melhores vendedores tinham mais tempo de casa'],
 0,
...
('m1_l1', 2, 'Por que responder o preço imediatamente costuma custar a venda?',
 array['Porque o cliente passa a te comparar por um número, sem saber o que ele resolve',
       'Porque demonstra que você não tem confiança no produto',
...
('m1_l1', 3, 'Segundo a aula, por que perguntar é difícil na prática?',
 array['Porque exige aguentar o silêncio, e falar alivia a tensão do vendedor',
       'Porque o cliente se irrita com perguntas',
...
('m1_l2', 1, 'Qual é o erro mais comum com as perguntas de situação?',
 array['Fazer muitas seguidas, transformando a conversa em interrogatório',
       'Fazê-las antes das perguntas de problema',
       'Usá-las com clientes que já compram de você',
...
('m1_l2', 3, 'Por que não se deve pular direto para a pergunta de ganho?',
 array['Porque sem um problema estabelecido, ela soa como propaganda',
       'Porque é a pergunta mais difícil de responder',
       'Porque o cliente ainda não confia em você',
...
('m1_l3', 1, 'O que caracteriza uma pergunta de impacto?',
 array['Ela faz o cliente calcular o que o problema custa a ele',
       'Ela apresenta a solução de forma indireta',
       'Ela confirma se o cliente tem orçamento',
...
('m1_l3', 2, 'Um cliente diz "às vezes falta produto aqui". Qual é a melhor resposta?',
 ...
 0,
 'As outras três partem para a solução antes de o cliente perceber o tamanho do problema. A primeira faz ele calcular — e é aí que a urgência nasce.'),
...
('m1_l3', 4, 'Quando parar de fazer perguntas de impacto?',
 array['Quando o cliente demonstrar que percebeu o tamanho do problema',
       'Depois de exatamente cinco perguntas',
...
('m1_l4', 1, 'Qual é o problema de fugir da pergunta de preço?',
 array['Você parece caro e escorregadio ao mesmo tempo',
       'O cliente entende que o produto é premium',
       'A conversa fica longa demais',
       'Você perde a chance de dar desconto'],
 0,
...
('m1_l4', 2, 'O que é a "ponte" ensinada na aula?',
 array['Dar algo verdadeiro sobre preço e devolver uma pergunta de descoberta',
       'Adiar o preço até a visita técnica',
...
('m1_l5', 1, 'Por que esperar dois segundos depois que o cliente fala?',
 array['Porque ele costuma completar, e o complemento é mais verdadeiro',
       'Porque demonstra respeito',
       'Porque dá tempo de pensar na resposta',
...
('m1_l5', 2, 'Para que serve confirmar o que você entendeu antes de responder?',
 array['Para corrigir o entendimento antes de construir uma proposta errada',
...
('m1_l5', 3, 'Por que anotar o que o cliente disse importa tanto?',
 array['Porque abrir a próxima conversa com o assunto dele vence a concorrência',
       'Porque protege juridicamente em caso de disputa',
       'Porque o gestor precisa acompanhar',
       'Porque ajuda a lembrar o preço combinado'],
 0,
